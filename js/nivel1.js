...
//};
//let presentYear = Number(prompt('Ingrese el año actual'));
//let age = Number(prompt('Ingrese año de nacimiento'));

//console.log(edad(presentYear,age));
...
console.log(`El resultado de la suma entre ${valor} ${operador} ${valor2} es igual a ${resultado}`);
*/
//****************************************************
...
let miApellido = prompt('íngresa tu apellido')
console.log(saludo (miNombre, miApellido));*/
...
if (operador === '+') {
    ...
    console.log('perdon no conozco este operador')    
}
