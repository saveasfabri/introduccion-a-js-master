...
//FH//let comidasFavoritas = ['milanesas' , 'pizza' , 'asado' , 'pastas'];
...
//FH// console.log(comidasFavoritas.length);
...
/*FH let comidasFavoritas = ['milanesas' , 'pizza' , 'asado' , 'pastas'];
console.log(comidasFavoritas[2]); //asado */
...
//FH//console.log(comidasFavoritas);
...
/*FH let comidasFavoritas = ['milanesas' , 'pizza' , 'asado' , 'pastas'];
comidasFavoritas.push('sandwich de mila'); */
...
/*FH const comidasFavoritas = ['milanesas' , 'pizza' , 'asado' , 'pastas'];
comidasFavoritas[3] = 'pancho'
...
//EJEMPLO PROMEDIOS DE NOTA
/*FH let notas = [10 , 7 , 8 , 5 , 9];
let totalNotas = 0;
for (let i = 0; i < notas.length; i++) {
    totalNotas = totalNotas + notas[i];    
}
console.log(`El valor de la variable "totalNotas" sumando las notas dentro del array (${notas}) es igual a ${totalNotas}`);

let promedioNotas = totalNotas / notas.length
console.log(`El promedio de nota se calcula dividiendo la variable "totalNotas" (${totalNotas}) y la variable "notas.length" (${notas.length})`)
console.log(`el promedio de notas (promedioNotas) es ${promedioNotas}`) */
